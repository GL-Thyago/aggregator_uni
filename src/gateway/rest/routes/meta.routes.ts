...
export const API_ROUTES: RouteInfo[] = [
  ...
  { method: "GET", path: "/admin/v1/billing/report", auth: "admin", description: "Cobrança por GGR (cliente, provedor, % Salsa)" },
  { method: "GET", path: "/admin/v1/billing/spins", auth: "admin", description: "Jogadas paginadas do relatório de cobrança" },
  { method: "GET", path: "/admin/v1/billing/export", auth: "admin", description: "Exportar cobrança em CSV/Excel" },
  ...
  { method: "POST", path: "/admin/v1/integrations/salsa/sync", auth: "admin", description: "Importar um provedor Salsa (?provider=46)" },
  ...
  { method: "POST", path: "/admin/v1/integrations/salsa/reset-catalog", auth: "admin", description: "Apagar jogos Salsa importados e estatísticas de jogo" },
